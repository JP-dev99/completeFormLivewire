                        ...
                        @auth
                            ...
                            >
                                ...
                                @if (Route::has('register'))
                                   <a href="{{ route('register') }}" class="font-medium text-indigo-600 transition duration-150 ease-in-out hover:text-indigo-500 focus:outline-none focus:underline">Registrar novo admin</a>
                                @endif
                        @else
                            <a href="{{ route('login') }}" class="font-medium text-gray-900 transition duration-150 ease-in-out hover:text-indigo-500 focus:outline-none focus:underline">Entrar</a>
